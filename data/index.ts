...
export const gridItems = [
  ...
  },
  {
    ...
    description:
      "Passionate about building modern frontend interfaces, scalable backend systems, and efficient database architectures.",
  ...
  },
  {
    ...
    description:
      "Experienced in frontend development, backend architecture, APIs, and database management.",
...
export const projects = [
  {
    ...
    des: "Explore the Event booking SaaS project you could book your own events over here",
    img: "/event.jpg",
...

  {
    ...
    des: "A modern full-stack banking platform with secure authentication, real-time transactions, and multi-bank account management.",
    img: "/horizon.png",
    iconLists: ["/next.svg", "/tail.svg", "/ts.svg", "/stream.svg", "/c.svg"],
    link: "https://banking-nine-ebon.vercel.app/signin",
  },
...

  {
    ...
    des: "Apple-inspired animated website using GSAP and Three.js.",
    img: "/p4.svg",
...
export const workExperience = [
  {
    ...
    desc: "Building scalable full-stack applications using MongoDB, Express.js, React, Next.js, and Node.js.",
...

  {
    ...
    desc: "Designing secure REST APIs, authentication systems, and optimized database architectures with MongoDB and SQL.",
    className: "md:col-span-2",
    thumbnail: "/exp2.svg",
  },

  {
    ...
    desc: "Deploying modern applications with Docker, GitHub, Vercel, and automated CI/CD workflows for production-ready systems.",
    className: "md:col-span-2",
    thumbnail: "/exp3.svg",
  },

  {
    ...
    desc: "Improving application performance, debugging complex issues, and creating responsive, user-friendly interfaces.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
];
